# Programmatic layout gate: re-executes nsys_profiling.py in-process, then
...
g = runpy.run_path(r"C:\Users\barry\Desktop\ml-infra-journey\physics-llm-inference-working\nsys-profiling\nsys_profiling.py")
fig = g["fig"]
fig.canvas.draw()
...
panel_names = ["A workflow", "B stats", "C timeline", "D gaps", "E copies+streams", "F nvtx+metrics"]
issues = 0
global_texts = []
