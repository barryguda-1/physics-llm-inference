# Programmatic layout gate: re-executes gemv.py in-process, then checks every
...
g = runpy.run_path(r"C:\Users\barry\Desktop\ml-infra-journey\physics-llm-inference-working\gemv\gemv.py")
fig = g["fig"]
fig.canvas.draw()
...
panel_names = ["A anatomy", "B intensity-vs-n", "C roofline",
               "D decode-step", "E batching", "F takeaway"]
issues = 0
global_texts = []
