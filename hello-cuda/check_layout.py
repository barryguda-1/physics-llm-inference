# Programmatic layout gate: re-executes hello_cuda.py in-process, then
...
g = runpy.run_path(r"C:\Users\barry\Desktop\ml-infra-journey\physics-llm-inference-working\hello-cuda\hello_cuda.py")
fig = g["fig"]
fig.canvas.draw()
...
panel_names = ["A kernel+launch", "B indexing", "C bounds", "D grid-stride", "E memory", "F python"]
issues = 0
global_texts = []
